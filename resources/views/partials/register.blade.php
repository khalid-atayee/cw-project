      ...
      <form id="formId" class="px-4 text-start register-form">
          ...
          <div class="row">
              ...
              <div class="mb-3 col-sm-6">
                  ...
                  <input type="text" class="form-control" name="lastname" id="full-name"
          ...
          <div class="row">
              ...
              <div class="mb-3 col-sm-6">
                  ...
                  <input type="contact" class="form-control" name="contact" id="contact"
                      aria-describedby="contact" placeholder="e.g. +93 7*** ***">
          ...
          <div class="row ">
              <div class="mb-3 ">
                  ...
                  <textarea class="form-control" placeholder="Please type here..." id="self-introduction" style="height: 100px"
              ...
              <div class="container-or-sign-in">
                <span>
                  ...
                  <span class="text-muted px-3"> Please Create an Account For Yourself</span>
                 <span>
                    <hr>
                </span> 
              </div>
              <div class="row">
                ...
                <div class="mb-3 col col-sm-6">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="Please type your email"
              ...
              <div class="d-grid d-md-block text-sm-center  my-4">
                  ...
                  <button type="button" onclick="postForm('{{ route('students.store') }}','POST','formId' ,'register-btn')"
                      class="btn btn-primary btn-submit register-btn"> <i class="fa fa-spinner fa-spin louder show-loader"></i>
                      Submit</button>
              </div>
