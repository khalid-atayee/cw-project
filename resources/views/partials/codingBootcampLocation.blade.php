...
<div class="coding-bootcamp-location " data-aos="fade-down">
  <div class="coding-bootcamp-location-content">
    <h2 class="fs-cw-gain fw-bold " data-aos="fade-left">CodeWeekend Bootcamp <span style="color:#06d6a0"> {{ isset($data)?  $data->title . '-'. $data->city->city_name : '[Location]' }}</span> </h2>
