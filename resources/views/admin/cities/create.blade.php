<x-layout>
    ...
    <div>
        <form class="tw-flex tw-flex-col tw-space-y-2 tw-border tw-p-5 tw-rounded-md tw-shadow" action="{{ route('cities.store') }}" method="POST">
            @csrf
            <div class="tw-flex">
                <label class="tw-w-[20%] tw-p-2" for="city_name">City name</label>
                <input class="tw-w-[80%] tw-border tw-p-2 tw-rounded-md" type="text" name="city_name" id="city_name" placeholder="city name" />
            </div>

            <div class="tw-flex">
                <label class="tw-w-[20%] tw-p-2" for="country">Country</label>
                <input class="tw-w-[80%] tw-border tw-p-2 tw-rounded-md" type="text" name="country" id="country" placeholder="country" />
            </div>
